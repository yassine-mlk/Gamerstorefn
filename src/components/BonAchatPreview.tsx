...
export function BonAchatPreview({ vente, isOpen, onClose, onPrint, onDownload: _onDownload }: InvoicePreviewProps) {
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto bg-white text-black">
        <DialogHeader className="no-print">
          <div className="flex items-center justify-between">
            <DialogTitle className="text-black text-xl">
              Aperçu Bon d'achat {numeroFacture}
            </DialogTitle>
        ...
        <div className="invoice-preview-container bg-white border rounded-lg flex flex-col min-h-[297mm]" style={{
          ...
          <div className="flex justify-between items-center mb-6 pb-2 border-b-2 border-black relative">
            ...
            <div className="text-2xl font-bold absolute left-1/2 transform -translate-x-1/2">Bon d'achat</div>
          ...
          <div className="bg-gray-100 p-4 mb-5 flex justify-between">
            <div className="flex-1">
              <div className="font-bold mb-1">Bon d'achat :</div>
          ...
          {/* Montant en lettres */}
             ...
             Arrete le present bon d'achat a la somme de {convertirMontantEnLettres(totalFinal)} {taxMode === "with_tax" && tva > 0 ? 'TTC' : 'HT'}
            </div>
