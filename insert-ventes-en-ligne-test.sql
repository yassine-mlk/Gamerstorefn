-- Script pour insérer des ventes de test de type "en_ligne"
-- Exécuter ce script APRÈS avoir créé les tables de livraisons

-- Insérer quelques ventes en ligne de test
INSERT INTO ventes (
    client_nom,
    client_email,
    client_telephone,
...
(
    ...
    'Commande en ligne - Setup bureau'
),
(
    'Omar Slimani',
    ...
    'Commande en ligne - Moniteur + clavier'
),
(
    'Aicha Bennani',
    ...
    'Commande en ligne - PC Portable gaming'
),
(
    'Youssef Tazi',
    ...
    'Commande en ligne - Périphériques gaming'
);
...
SELECT 
    ...
    2400.00
FROM ventes v 
WHERE v.client_nom = 'Ahmed Benali' AND v.type_vente = 'en_ligne'
LIMIT 1;
...
SELECT 
    ...
    1200.00
FROM ventes v 
WHERE v.client_nom = 'Fatima Zahra' AND v.type_vente = 'en_ligne'
LIMIT 1;
...
SELECT 
    ...
    1000.00
FROM ventes v 
WHERE v.client_nom = 'Omar Slimani' AND v.type_vente = 'en_ligne'
LIMIT 1;
...
SELECT 
    ...
    3500.00
FROM ventes v 
WHERE v.client_nom = 'Aicha Bennani' AND v.type_vente = 'en_ligne'
LIMIT 1;
...
SELECT 
    ...
    300.00
FROM ventes v 
WHERE v.client_nom = 'Youssef Tazi' AND v.type_vente = 'en_ligne'
LIMIT 1;
