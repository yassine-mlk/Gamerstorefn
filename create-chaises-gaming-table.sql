-- Script SQL pour créer la table des chaises gaming
-- Gamerstore - Gestion des chaises gaming

-- Créer la table chaises_gaming
CREATE TABLE IF NOT EXISTS public.chaises_gaming (
...
SELECT id, nom_produit, marque, prix_achat, prix_vente, stock_actuel, statut, created_at 
FROM public.chaises_gaming 
ORDER BY created_at DESC;

NOTIFY setup_complete, 'Table chaises_gaming créée avec succès!';

-- Commentaires sur la table et les colonnes
COMMENT ON TABLE public.chaises_gaming IS 'Table pour stocker les informations des chaises gaming';
COMMENT ON COLUMN public.chaises_gaming.id IS 'Identifiant unique de la chaise gaming';
